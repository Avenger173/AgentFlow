...
def _apply_langgraph_composition_trial_admissions_v1(connection: sqlite3.Connection) -> None:
    """建立 LGM5.7 开发者试点的脱敏准入/撤销记录。"""

    connection.executescript(
        """
        CREATE TABLE langgraph_composition_trial_admissions (
            runtime_task_id TEXT PRIMARY KEY,
            plan_digest TEXT NOT NULL,
            status TEXT NOT NULL CHECK (status IN ('admitted', 'rejected', 'revoked')),
        ...
        CREATE INDEX idx_langgraph_composition_trial_admissions_status_updated
...
_SCHEMA_MIGRATIONS: tuple[_SchemaMigration, ...] = (
    ...
    _SchemaMigration(
        migration_id="20260907_langgraph_composition_trial_admissions_v1",
        signature=(
            "langgraph_composition_trial_admissions:v1;runtime_task_unique;plan_digest_and_opaque_evidence_only;"
