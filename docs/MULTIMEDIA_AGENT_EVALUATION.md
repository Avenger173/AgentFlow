...
> 版本：v1.6 | 建立日期：2026-09-16 | 最近更新：2026-09-22
>
...
该脚本只覆盖真实 Windows 桌面打开路径和退出清理，不执行鼠标注入或绕过文件选择框，也不覆盖导入、蒙版、图层、导出和 DPI 档位。因此它补强了 Qt 启动/窗口可达性证据，但不能改变 L1 “进行中”的结论；完整本地夹具、真实 Windows `100% / 150% / 200%` 流程和人工边界复核仍是后续必做项。
