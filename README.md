...
- [功能界面展示](#功能界面展示)
  - [AI 调度与任务执行](#ai-调度与任务执行)
  - [文档与 PPT 制作](#文档与-ppt-制作)
  - [数据工作台](#数据工作台)
  - [本地知识库](#本地知识库)
  - [任务历史与长期记忆](#任务历史与长期记忆)
- [核心能力](#核心能力)
- [工作方式](#工作方式)
- [技术特点](#技术特点)
  - [可审计的 Agent Runtime](#可审计的-agent-runtime)
  - [分层记忆](#分层记忆)
  - [可信检索](#可信检索)
  - [可替换模型网关](#可替换模型网关)
  - [交付物回读验证](#交付物回读验证)
...
| 多媒体助手（内部） | AI 修图最小闭环：调度台安全交接、Qwen 图像编辑路由、失败分类、可撤销 revision 和重启对账；调度台不会隐式上传或调用模型，合成夹具真实回读和 `G2-DEV` 已通过，正式独立复核与发布验收待进行 |
