...
private:
    ...
    void handleModelCatalogReceived(const ModelCatalogResult &result);
    void handleModelCatalogFailed(const QString &message);
    ...
    void refreshSelectedModelCatalog();
    ModelGenerationParametersInfo selectedModelParameters() const;
    void setSelectedModelParameters(const ModelGenerationParametersInfo &parameters);
...
private:
    ...
    QComboBox *modelConfigModelInput = nullptr;
    QLineEdit *modelConfigApiKeyInput = nullptr;
    QComboBox *modelConfigThinkingCombo = nullptr;
    QDoubleSpinBox *modelConfigTemperatureSpin = nullptr;
    QSpinBox *modelConfigMaxTokensSpin = nullptr;
    QPushButton *modelCatalogRefreshButton = nullptr;
